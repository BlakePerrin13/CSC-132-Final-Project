...
def card_load(name):
    card = pyg.transform.rotozoom(pyg.image.load('./card_images/{}.png'.format(name)), 0, 0.14)
    return card
...
raise_bet = pyg.transform.rotozoom(pyg.image.load('./card_images/raise.png'), 0, 1.1)
lower_bet = pyg.transform.rotozoom(pyg.image.load('./card_images/lower.png'), 0, 1.1)
set_bet = pyg.transform.rotozoom(pyg.image.load('./card_images/set_bet.png'), 0, 1.1)
purple_back = pyg.transform.rotozoom(pyg.image.load('./card_images/purple_back.png'), 0, 0.14)
